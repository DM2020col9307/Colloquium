...
• reduceQ( ) - Сокращение дроби
• rdc( ) - Сокращение дроби
• reducefraction( ) - Сокращение дроби
• defrac( ) - Сокращение дроби
• deg( ) - Старшая степень полинома
• degree( ) - Старшая степень полиома
• lead( ) - Старший коэффициент полинома
• leadcoef( ) - Старший коэффициент полинома
• factor( ) - Факторизация полинома
• factorize( ) - Факторизация полинома
'''
    messagebox.showinfo("Help", information)
def btn_ok():
    output.delete(0,END)
    output.insert(0,eval(parse(input_text.get())))
